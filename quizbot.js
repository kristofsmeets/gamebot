...
//javascript:(function()%7B$.getScript('https://raw.github.com/kristofsmeets/gamebot/master/quizbot.js');%7D());
                    ...
                    if (this.answerMode.length === 1 && data.fromID !== API.getUser().id) {
                            ...
                            if (answerCorrect === true) {
                                    ...
                                    if (this.playerNames.indexOf(data.fromID) === -1) {
                                            ...
                                            var str = '@' + data.from + theme + points + ' pts'
                                            API.sendChat(str)
                                    }
                            }
                    }
            ...
            onDjAdvance: function(obj) {
                    ...
                    case 2:
                            ...
                            if (this.answerMode.length === 1) {
                                    ...
                                    else { API.sendChat('I am sad now, nobody answered my question correct :( the correct answer was :' + a[w][0] + 'Next question after this song (Better luck this time ;) ') }
